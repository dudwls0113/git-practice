...
class StoryLargeTextEditCell: UITableViewCell {
    
    static let cellReuseIdentifier: String = "Story Large Text Edit Cell"
    ...
    override func awakeFromNib() {
        ...
        attributedStr.addAttribute(.font, value: UIFont(name: "Georgia-Bold", size: 22.0)!, range: NSRange(location: 0, length: placeholder.count))
...
extension StoryLargeTextEditCell: UITextViewDelegate {
...
//    }
    ...
    func textViewSetupView() {
        if textView.text == placeholder {
            ...
            attributedStr.addAttribute(.font, value: UIFont(name: "Georgia-Bold", size: 22.0)!, range: NSRange(location: 0, length: temp.count))
