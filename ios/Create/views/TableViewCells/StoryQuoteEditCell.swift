...
class StoryQuoteEditCell: UITableViewCell {

    static let cellReuseIdentifier: String = "Story Quote Edit Cell"
    ...
    override func awakeFromNib() {
        ...
        attributedStr.addAttribute(.font, value: UIFont(name: "Georgia-Italic", size: 20.0)!, range: NSRange(location: 0, length: placeholder.count))
    ...
    func updateUI(_ text: String?, at index: Int, delegate: EditingTableViewDelegate) {
        ...
        textView.textColor = (text != nil) ? .darkGray : .lightGray
...
extension StoryQuoteEditCell: UITextViewDelegate {
...
//    }
    ...
    func textViewSetupView() {
        if textView.text == placeholder {
            ...
            attributedStr.addAttribute(.foregroundColor, value: UIColor.darkGray, range: NSRange(location: 0, length: temp.count))
            attributedStr.addAttribute(.font, value: UIFont(name: "Georgia-Italic", size: 20.0)!, range: NSRange(location: 0, length: temp.count))
            ...
            attributedStr.addAttribute(.font, value: UIFont(name: "Georgia", size: 20.0)!, range: NSRange(location: 0, length: placeholder.count))
            textView.attributedText = attributedStr
        }
    }
}
